 ...
 */
@RestController
@RequestMapping("/api/count/department")
...
public class CountController {
    ...
    /*******************按职称统计一个部门的员工情况**************/
    @GetMapping("/{id}/title")
    public Map<String, Object> countEmpDepByTitle(@PathVariable("id") int id) {
    ...
    public Map<String, Object> countEmpDepByGender(@PathVariable("id") int id) {
        QueryWrapper<Employee> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq("N_DEPT_ID", id);
        List<Employee> employees = employeeService.list(queryWrapper);
    ...
    /*******************按学历统计一个部门的员工情况**************/
    @GetMapping("/{id}/level")
    public Map<String, Object> countEmpDepByLevel(@PathVariable("id") int id) {
        QueryWrapper<Employee> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq("N_DEPT_ID", id);
        List<Employee> employees = employeeService.list(queryWrapper);
    ...
    /*******************按年龄统计一个部门的员工情况**************/
    @GetMapping("/{id}/age")
    public Map<String, Object> countEmpDepByAge(@PathVariable("id") int id) {
        QueryWrapper<Employee> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq("N_DEPT_ID", id);
        List<Employee> employees = employeeService.list(queryWrapper);
